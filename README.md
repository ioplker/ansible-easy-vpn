# ansible-easy-vpn
![CI](https://github.com/ioplker/ansible-easy-vpn/actions/workflows/ci.yml/badge.svg)
...
```
wget https://raw.githubusercontent.com/ioplker/ansible-easy-vpn/without-ssh-hardening/bootstrap.sh -O bootstrap.sh && bash bootstrap.sh
```
